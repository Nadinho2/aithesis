...
export const Route = createFileRoute("/_authenticated/community/buy-resources")({
  component: BuyResourcesPage,
});

function BuyResourcesPage() {
    ...
    <div className="flex flex-col h-full">
      {isMobile && (
        <div className="px-5 py-4 border-b border-ink/10 bg-white flex-shrink-0 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-serif text-lg font-bold text-ink">Buy resources</h2>
