...
import { ArrowLeft, Loader2, Upload, GraduationCap, X, Sparkles, FileQuestion, FileText, ImageIcon, Info, Check, BookOpen } from "lucide-react";
...
function ExamPage() {
  ...
  if (pathname !== "/tools/exam") return <Outlet />;
