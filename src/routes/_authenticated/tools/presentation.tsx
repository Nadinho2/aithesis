  ...
  const download = async (format: "pptx" | "docx") => {
    ...
    try {
      if (format === "pptx") {
        ...
        pptx.title = topic;
        pptx.author = "Mybrainpadi";
        pptx.defineSlideMaster({
          title: "PRESENTATION",
          slideNumber: { x: 9.0, y: 6.9, color: activeTheme.accent, fontSize: 9 },
        });
        ...
        cover.addText("Generated by Mybrainpadi", {
          x: 1.0, y: 6.3, w: 8.0, h: 0.4, fontSize: 10, color: activeTheme.bullets, align: "center",
        });
