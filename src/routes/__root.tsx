  ...
  head: () => ({
    meta: [
      ...
      { title: "ThesisPro — Your research, structured and sourced" },
      {
        name: "description",
        content:
          "Find your research topic, discover sources, and draft well-structured proposals and theses with citations verified against OpenAlex and Crossref.",
      },
      { property: "og:title", content: "ThesisPro — Your research, structured and sourced" },
      {
        property: "og:description",
        content: "A research writing partner that helps you build well-sourced academic work.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ThesisPro — Your research, structured and sourced" },
      { name: "description", content: "ThesisPro is a research writing partner that helps students build well-sourced theses and dissertations from proposal to completion." },
      { property: "og:description", content: "ThesisPro is a research writing partner that helps students build well-sourced theses and dissertations from proposal to completion." },
      { name: "twitter:description", content: "ThesisPro is a research writing partner that helps students build well-sourced theses and dissertations from proposal to completion." },
