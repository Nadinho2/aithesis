    ...
    <div className="min-h-screen bg-paper text-ink font-sans">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-sm max-w-none text-ink-secondary leading-[1.7] space-y-5">
          ...
          <p>
            By accessing or using Mybrainpadi, you agree to be bound by these Terms of Service.
          ...
          <p>
            Mybrainpadi provides an education ecosystem, including research topic discovery, proposal
          ...
          <p>
            You retain full ownership of all research content you create using Mybrainpadi.
          ...
          <p>
            We strive for high availability but do not guarantee uninterrupted access. Mybrainpadi
          ...
          <p>
            Mybrainpadi is provided &quot;as is&quot; without warranties of any kind. We are not
          ...
          <p className="italic mt-8 text-sm">
            Last updated: June 2026. Contact legal@mybrainpadi.com with questions.
          </p>
        </div>
      </div>
    </div>
